...
app.route('/update/:id').put(function(req,res){
    var sql = "UPDATE `E-COMMERCE`.PRODUCT SERT name = ?, description = ?, price = ?, category_id = ?, picture = ? WHERE id = ?";
...
app.route('/add').post(function(req,res0){
    var sql = "INSERT INTO `E-COMMMERCE`.PRODUCT (name, description, price, category,_id, picture) VALUES(?,?,?,?,?)";
